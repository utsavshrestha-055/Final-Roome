...
import { Avatar as h, Initials as g } from "../../Avatar/Avatar.js";
...
`, t = m.forwardRef(({ src: o, children: e, initials: a, ...s }, p) => {
  const d = c();
  return /* @__PURE__ */ r(y, { paddingTop: 3, paddingBottom: 3, paddingLeft: 5, paddingRight: 5, ...s, children: /* @__PURE__ */ l(u, { as: "button", justifyContent: d ? "center" : void 0, ref: p, children: [
    o ? /* @__PURE__ */ r(h, { src: o, alt: "", "aria-hidden": !0 }) : /* @__PURE__ */ r(g, { children: a }),
