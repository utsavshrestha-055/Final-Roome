...
import per from "../../assets/person1.jpeg";
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-body-color mb-9 text-base leading-relaxed">
                  To provide white-glove service and receive detailed assistance
                  for room rentals, you can contact our customer service team
                  from 8 AM to 6 PM, Monday through Friday. Our dedicated team
                  is here to assist you with various aspects of your room rental
                  experience on ROOME,
                  <ul className="p-0">
                    <li>Room Search and Booking</li>
                    <li>Account Creation</li>
                    <li>Room Information and Details</li>
                    <li>Site Navigation</li>
                    <li>Assistance with Room-related Issues</li>
                  </ul>
                </p>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">roome@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4 flex flex-col lg:items-center justify-between lg:flex-row">
              <div className="mb-14 xl:mb-0">
                ...
                <p className="mt-4 text-base leading-normal text-gray-600 md:w-2/3 lg:w-3/4 pr-16 lg:pr-0">
                  Over 500 customers use roome to book and upload rooms as well
                  as flats.
                </p>
              ...
              >
                  ...
                  <div className="pl-4 pt-4 flex items-start justify-between">
                    <div className="mr-6">
                      <p className="xl:text-xl xl:leading-loose text-gray-600">
                        I recently completed my first room rental booking on
                        ROOME, and I wanted to express my complete satisfaction
                        and happiness with the experience. I am extremely
                        pleased with the service provided and would like to
                        acknowledge my gratitude for the excellent work done by
                        the ROOME team. The entire process was smooth and
                        efficient, and I truly appreciate the hard work and
                        dedication put into ensuring a seamless room rental
                        experience. Thank you for your exceptional service!
                      </p>
                ...
                >
                  <div className="pl-4 pt-4 flex items-start justify-between">
                    <div className="mr-6">
                      <p className="xl:text-xl xl:leading-loose text-gray-600">
                        I was seeking a room rental website that provides a
                        user-friendly interface, simplifies the room search
                        process, and offers detailed information about available
                        rooms.
                      </p>
                      <p className="mt-4 text-base font-semibold leading-none text-gray-800">
                        Sushant Karki
